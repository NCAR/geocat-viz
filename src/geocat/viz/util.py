...
def findLocalExtrema(da: xr.DataArray,
                     ...
                     eType: str = 'Low',
                     eps: float = 10) -> list:
    r""".. deprecated:: 2023.02.0 The ``findLocalExtrema`` function is deprecated due to naming conventions. Use `find_local_extrema </en/latest/user_api/generated/geocat.viz.util.find_local_extrema.html>`__ instead.
...
def plotCLabels(ax: matplotlib.axes.Axes,
    ...
    r""".. deprecated:: 2023.02.0 The ``plotCLabels`` function is deprecated due to naming conventions. Use `plot_contour_levels </en/stable/user_api/generated/geocat.viz.util.plot_contour_levels.html>`__ instead.
...
def plotELabels(da: xr.DataArray,
    ...
    r""".. deprecated:: 2023.02.0 The ``plotELabels`` function is deprecated due to naming conventions. Use `plot_extrema_labels </en/stable/user_api/generated/geocat.viz.util.plot_extrema_labels.html>`__ instead.
