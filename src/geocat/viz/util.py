...
def add_lat_lon_gridlines(ax,
    ...
    *kwargs* control line properties and are passed through to `matplotlib.collections.Collection`.
    ...
    Examples
    --------
    See this `example notebook <../../examples/add_lat_lon_gridlines.html>`__.
...
def add_height_from_pressure_axis(ax,
    ...
    Examples
    --------
    See this `example notebook <../../examples/add_height_from_pressure_axis.html>`__.
...
def add_lat_lon_ticklabels(ax: typing.Union[matplotlib.axes.Axes,
    ...
    Examples
    --------
    See this `example notebook <../../examples/add_lat_lon_ticklabels.html>`__.
