...
class NCL_Plot(_fig_ax, add_geo_features):
    """Parent class to create figure, axes, set NCL style with constructors to add colorbar, add titles, and show plot.
    ...
    def __init__(self, *args, **kwargs):
        """Pulls kwargs for colorbar and titles. Calls _fig_ax to set up figure and axes, add_geo_features to add geographical features to the figure, and adds titles.
